...
public class LoginDaoImpl implements LoginDao{
	...
	public List<Student> loginDao(String email, String password) {
		...
		try {
			String psql_query = "select * from register where email=? and password=?";
			students_list = jdbcTemplate.query(psql_query, new StudentMapper(),new Object[] {email,password});
